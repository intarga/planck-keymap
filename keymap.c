...
[_FERRIS] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, L3,      KC_SPC,  _______, _______, KC_SPC,  L2,      _______, _______, _______
),

[_L2] = LAYOUT_planck_grid(
    KC_0,    KC_1,    KC_2,    KC_3,    KC_GRV,  _______, _______, KC_LALT, KC_LBRC, KC_RBRC, KC_TAB,  KC_ESC,
...
// ),
[_LOWER] = LAYOUT_planck_grid(
    _______, KC_CIRC, KC_AMPR, KC_UNDS, KC_PIPE, KC_LBRC, KC_RBRC, KC_1,    KC_2,    KC_3,    KC_MINS, KC_SLSH,
    _______, KC_BSLS, KC_DLR,  KC_AT,   KC_TILD, KC_LCBR, KC_RCBR, KC_4,    KC_5,    KC_6,    KC_PLUS, _______,
    _______, _______, KC_GRV,  KC_PERC, KC_HASH, KC_LPRN, KC_RPRN, KC_7,    KC_8,    KC_9,    KC_EQL,  _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_0,    KC_DOT,  KC_COMM, KC_ASTR
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_VOLD, KC_VOLU, KC_BRID, KC_BRIU, KC_PSCR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, KC_MUTE, KC_MRWD, KC_MPLY, KC_MFFD, _______, QK_BOOT, _______, _______, KC_INS,  KC_HOME, KC_PGUP,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  FERRIS,  PLOVER,  _______,
